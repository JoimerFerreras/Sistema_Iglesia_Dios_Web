...
{
    public class Archivo_Cuenta_Pagar_D
    {
        ...
        public DataTable Listar(int Id_Cuenta_Pagar)
        {
            using (SqlConnection conexion = new SqlConnection(Conexion_D.CadenaSQL))
            {
                string sentencia = $@"SELECT 
                                        ...
                                        FROM Archivos_Cuentas_Por_Pagar 
                                        WHERE Id_Cuenta_Pagar = @Id_Cuenta_Pagar ORDER BY Id_Archivo";
        ...
        {
            Archivo_Cuenta_Pagar_E entidad = new Archivo_Cuenta_Pagar_E();
        ...
        public int Agregar(Archivo_Cuenta_Pagar_E entidad)
        {
            int Id = 0;

            using (SqlConnection conexion = new SqlConnection(Conexion_D.CadenaSQL))
            {
                string sentencia = $@"INSERT INTO Archivos_Cuentas_Por_Pagar(
                                        Id_Cuenta_Pagar,
                                        NombreArchivo,
                                        NombreArchivoCarpeta,
                                        TipoArchivo,
        ...
        public bool Eliminar(int Id)
        {
            ...
            using (SqlConnection conexion = new SqlConnection(Conexion_D.CadenaSQL))
            {
                string sentencia = "DELETE FROM Archivos_Cuentas_Por_Pagar WHERE Id_Archivo = @id;";
                SqlCommand cmd = new SqlCommand(sentencia, conexion);
