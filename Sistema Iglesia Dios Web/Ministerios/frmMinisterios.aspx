<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmMinisterios.aspx.cs" Inherits="Sistema_Iglesia_Dios_Web.Ministerios.frmMinisterios" %>
        ...
        <div class="shadowed-div-body" style="width: 100%;">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <asp:TextBox runat="server" ID="txtNombreMinisterio" CssClass="form-control form-control" Width="100%" TabIndex="2"></asp:TextBox>
                </div>
                    ...
                    <MasterTableView AutoGenerateColumns="False">
                        <Columns>
                            <telerik:GridTemplateColumn>
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("Id_Ministerio") %>' OnClick="btnEditar_Click" CssClass="btn btn-sm btn-primary fa-solid fa-pen boton_formulario_editar" Style="height: 30px; width: 30px; padding: 7px; border-radius: 15px; margin-bottom: 3px;"></asp:LinkButton>
                                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("Id_Ministerio") %>' OnClick="btnEliminar_Click" OnClientClick="return delalert(this);" CssClass="btn btn-sm btn-danger fa-solid fa-trash" Style="height: 30px; width: 30px; padding: 7px; border-radius: 15px;"></asp:LinkButton>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridBoundColumn DataField="Id_Ministerio" HeaderText="ID" HeaderStyle-Width="10%" ItemStyle-Width="10%">
