...
{
    [CodigoFuncionalidad("Departamentos")]
    public partial class frmDepartamentos : System.Web.UI.Page
    {
        ...
        private void LlenerCombos()
        {
            ...
            cmbLiderDepartamento.DataSource = dt;
            cmbLiderDepartamento.DataValueField = "Id_Miembro";
            cmbLiderDepartamento.DataTextField = "Nombre_Miembro";
            cmbLiderDepartamento.DataBind();

            cmbDiaconoDepartamento.DataSource = dt;
            cmbDiaconoDepartamento.DataValueField = "Id_Miembro";
            cmbDiaconoDepartamento.DataTextField = "Nombre_Miembro";
            cmbDiaconoDepartamento.DataBind();
        }
        #endregion
        ...
        private void Consultar()
        {
            ...
            DT_DATOS = Departamento_N.Listar();
        ...
        private bool ValidarCampos()
        {
            ...
            if (txtNombreDepartamento.Text.Length == 0)
            {
        ...
        private void GuardarRegistro()
        {
            ...
            try
            {
                if (ValidarCampos() == true)
                {
                    ...
                    Departamento_E Departamento_E = new Departamento_E();
                    Departamento_E.Id_Departamento = int.Parse(ID_REGISTRO);
                    Departamento_E.Nombre_Departamento = txtNombreDepartamento.Text;
                    Departamento_E.Estado = Convert.ToBoolean(cmbEstado.SelectedValue);
                    Departamento_E.Id_Lider_Departamento = int.Parse(cmbLiderDepartamento.SelectedValue);
                    Departamento_E.Id_Diacono_Departamento = int.Parse(cmbDiaconoDepartamento.SelectedValue);

                    if (EDITAR_REGISTRO == true)
                    {
                        
                        // Guardar registro existente
                        bool salida = Departamento_N.Editar(Departamento_E);
                    ...
                    {
                        // Agregar registro
                        bool salida = Departamento_N.Agregar(Departamento_E);
        ...
        private void VerRegistro()
        {
            ...
            Departamento_E Departamento_E = new Departamento_E();
            Departamento_E = Departamento_N.ObtenerRegistro(ID_REGISTRO);

            txtId_Descripcion.Text = Departamento_E.Id_Departamento.ToString();
            txtNombreDepartamento.Text = Departamento_E.Nombre_Departamento.ToString();
            cmbEstado.SelectedValue = Departamento_E.Estado.ToString();
            cmbLiderDepartamento.SelectedValue = Departamento_E.Id_Lider_Departamento.ToString();
            cmbDiaconoDepartamento.SelectedValue = Departamento_E.Id_Diacono_Departamento.ToString();
        }
        ...
        private void Eliminar(int Id_Registro)
        {
            ...
            {
                if (Departamento_N.RegistrosExistentes(Id_Registro) == false)
                {
                    bool respuesta = Departamento_N.Eliminar(Id_Registro);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                ((SiteMaster)Master).EstablecerNombrePantalla("Departamentos");
                LimpiarCampos();
