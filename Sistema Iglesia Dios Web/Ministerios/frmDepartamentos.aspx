<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmDepartamentos.aspx.cs" Inherits="Sistema_Iglesia_Dios_Web.Ministerios.frmDepartamentos" %>
        ...
        <div class="shadowed-div-body" style="width: 100%;">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <asp:TextBox runat="server" ID="txtNombreDepartamento" CssClass="form-control form-control" Width="100%" TabIndex="2"></asp:TextBox>
                </div>
            ...
            <div class="row" style="margin-top: 20px;">
                <div class="col-12 col-md-6">
                    <div>
                        Lider del Departamento
                    </div>
                    <telerik:RadComboBox ID="cmbLiderDepartamento" runat="server" Width="100%" ClientIDMode="Static"
                        MaxHeight="200px" AllowCustomText="True" Sort="Ascending" TabIndex="6"
                        MarkFirstMatch="true" OnClientKeyPressing="ChangeToUpperCase" RenderMode="Lightweight" Skin="Bootstrap"
                        Filter="Contains" DataValueField="Codigo" DataTextField="Nombre" AppendDataBoundItems="true" AutoPostBack="false">
                        <Items>
                ...
                <div class="col-12 col-md-6">
                    <div>
                        Diacono del Departamento
                    </div>
                    <telerik:RadComboBox ID="cmbDiaconoDepartamento" runat="server" Width="100%" ClientIDMode="Static"
                        MaxHeight="200px" AllowCustomText="True" Sort="Ascending" TabIndex="6"
                        MarkFirstMatch="true" OnClientKeyPressing="ChangeToUpperCase" RenderMode="Lightweight" Skin="Bootstrap"
                        Filter="Contains" DataValueField="Codigo" DataTextField="Nombre" AppendDataBoundItems="true" AutoPostBack="false">
                        <Items>
                    ...
                    <MasterTableView AutoGenerateColumns="False">
                        <Columns>
                            <telerik:GridTemplateColumn>
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("Id_Departamento") %>' OnClick="btnEditar_Click" CssClass="btn btn-sm btn-primary fa-solid fa-pen boton_formulario_editar" Style="height: 30px; width: 30px; padding: 7px; border-radius: 15px; margin-bottom: 3px;"></asp:LinkButton>
                                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("Id_Departamento") %>' OnClick="btnEliminar_Click" OnClientClick="return delalert(this);" CssClass="btn btn-sm btn-danger fa-solid fa-trash" Style="height: 30px; width: 30px; padding: 7px; border-radius: 15px;"></asp:LinkButton>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridBoundColumn DataField="Id_Departamento" HeaderText="ID" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="Nombre_Departamento" HeaderText="Nombre del Departamento" HeaderStyle-Width="90%" ItemStyle-Width="80%">
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="Lider_Departamento" HeaderText="Lider de Departamento" HeaderStyle-Width="90%" ItemStyle-Width="80%">
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="Diacono_Departamento" HeaderText="Diacono de Departamento" HeaderStyle-Width="90%" ItemStyle-Width="80%">
                            </telerik:GridBoundColumn>
