                ...
                <telerik:RadMultiPage runat="server" ID="rmpTabs" SelectedIndex="0">
                    <telerik:RadPageView runat="server" ID="rpvConsulta" Style="margin: 0 auto;">
                        <div class="shadowed-div-body" style="width: 100%; border-radius: 0px 10px 10px 10px;">
                            ...
                            <div class="row" style="margin-top: 20px;">
                                <div class="col-12 col-md-3">
                                    ...
                                    <telerik:RadComboBox ID="cmbSexoFiltro" runat="server" Width="100%" ClientIDMode="Static" Style="max-width: 200px;"
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <telerik:RadComboBox ID="cmbEstadoCivilFiltro" runat="server" Width="100%" ClientIDMode="Static" Style="max-width: 200px;"
                                        MaxHeight="200px" AllowCustomText="True" Sort="Ascending" TabIndex="6"
                                        MarkFirstMatch="true" OnClientKeyPressing="ChangeToUpperCase" RenderMode="Lightweight" Skin="Bootstrap"
                                        Filter="Contains" DataValueField="Codigo" DataTextField="Nombre" AppendDataBoundItems="true" AutoPostBack="false">
                                        <Items>
                                    ...
                                    <telerik:RadGrid RenderMode="Lightweight" ID="gvDatos" runat="server" Culture="es-DO" Style="overflow-x: auto;" BorderColor="White" MasterTableView-Width="100%" Width="100%" HeaderStyle-Font-Bold="true" AlternatingItemStyle-BackColor="#F1F5FF"
                                        ...
                                        <MasterTableView AutoGenerateColumns="False">
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="Nombre_Ministerio" HeaderText="Ministerio perteneciente" HeaderStyle-Width="30%" ItemStyle-Width="30%">
                                                </telerik:GridBoundColumn>
                                            </Columns>
                                        </MasterTableView>
                                    </telerik:RadGrid>
                        ...
                        <div class="contenedor_botones">
                            ...
                            <asp:LinkButton CssClass="fa-solid fa-file-pdf fa-lg boton_formulario_Agregar" runat="server" ID="btnGenerarPDF" OnClick="btnGenerarPDF_Click" OnClientClick="MostrarPanelCarga()" Enabled="false" Visible="false" data-tippy-content="Generar reporte en PDF"></asp:LinkButton>
                    ...
                    <telerik:RadPageView runat="server" ID="rpvRegistro" Style="margin: 0 auto;">
                        ...
                        <div class="shadowed-div-body" style="width: 100%;">
                            <div>
                                <i class="fa-solid fa-folder shadowed-div-body-titulo"></i><span class="shadowed-div-body-titulo">Datos generales</span>
                            </div>
                            <div class="linea-separador" style="margin-top: 20px;"></div>
                    ...
                    <asp:TextBox runat="server" ID="txtHermano5_Celular" CssClass="form-control form-control" Width="100%" MaxLength="15" TabIndex="2"></asp:TextBox>
                        ...
                        <div class="shadowed-div-body" style="width: 100%; margin-top: 20px;">
                            <div>
                                <i class="fa-solid fa-user shadowed-div-body-titulo" id="informacion_personal_panel"></i><span class="shadowed-div-body-titulo">Información personal (preferencias / gustos)</span>
                            </div>
                            <div class="linea-separador" style="margin-top: 20px;"></div>
                    ...
                    <asp:TextBox runat="server" ID="txtOtrosPasatiempos" CssClass="form-control form-control" Width="100%" MaxLength="100" TabIndex="2"></asp:TextBox>
                        ...
                        <div class="shadowed-div-body" style="width: 100%; margin-top: 20px;">
                            <div>
                                <i class="fa-solid fa-church shadowed-div-body-titulo"></i><span class="shadowed-div-body-titulo">&nbsp;Uso interno de la iglesia</span>
                            </div>
                            <div class="linea-separador" style="margin-top: 20px;"></div>
                            ...
                            <div class="row" style="margin-top: 20px;">
                                <div class="col-12 col-md-6">
                                    ...
                                    <telerik:RadComboBox ID="cmbMinisterio_Pertenece" runat="server" Width="100%" ClientIDMode="Static"
                                        MaxHeight="200px" AllowCustomText="True" Sort="Ascending" TabIndex="6"
                                        MarkFirstMatch="true" OnClientKeyPressing="ChangeToUpperCase" RenderMode="Lightweight" Skin="Bootstrap"
                                        Filter="Contains" DataValueField="Codigo" DataTextField="Nombre" AppendDataBoundItems="true" AutoPostBack="false">
                                        <Items>
                            ...
                            <div class="row" style="margin-top: 20px;">
                                ...
                                <div class="col-12 col-md-6">
                                    Nombre del diacono
                                    <asp:TextBox runat="server" ID="txtNombre_Diacono" CssClass="form-control form-control" Width="100%" MaxLength="100" TabIndex="2" ReadOnly="true"></asp:TextBox>
                                </div>
                                <div class="col-12 col-md-6">
                                    Nombre del lider de ministerio
                                    <asp:TextBox runat="server" ID="txtNombreLiderMinisterio" CssClass="form-control form-control" Width="100%" MaxLength="100" TabIndex="2" ReadOnly="true"></asp:TextBox>
                                </div>
                            </div>
