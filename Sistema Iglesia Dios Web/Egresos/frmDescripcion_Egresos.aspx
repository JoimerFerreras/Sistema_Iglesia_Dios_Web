                        ...
                        <Columns>
                            <telerik:GridTemplateColumn>
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("Id_Descripcion_Egreso") %>' OnClick="btnEliminar_Click" OnClientClick="return delalert(this);" CssClass="btn btn-sm btn-danger fa-solid fa-trash" Style="height: 30px; width: 30px; padding: 7px; border-radius: 15px;"></asp:LinkButton>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridBoundColumn DataField="Id_Descripcion_Egreso" HeaderText="ID" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="Descripcion_Egreso" HeaderText="Descripción" HeaderStyle-Width="90%" ItemStyle-Width="80%">
                            </telerik:GridBoundColumn>
