<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmDescripciones.aspx.cs" Inherits="Sistema_Iglesia_Dios_Web.Otros_Parametros.frmDescripciones" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="padding: 20px;">
        <div class="shadowed-div-body" style="width: 100%;">
            <div>
                <i class="fa-solid fa-file-pen shadowed-div-body-titulo"></i><span class="shadowed-div-body-titulo">Registro</span>
            </div>
            ...
            <div class="row">
                <div class="col-12 col-md-1">
                    ID
                    <asp:TextBox runat="server" ID="txtId_Descripcion" CssClass="form-control form-control" Width="100%" ReadOnly="true" TabIndex="1" Style="max-width: 150px;"></asp:TextBox>
                </div>

                <div class="col-12 col-md-6">
                    Nombre
                    <asp:TextBox runat="server" ID="txtNombreDescripcion" CssClass="form-control form-control" Width="100%" TabIndex="2"></asp:TextBox>
                </div>
                ...
                <div class="col-12 col-md-3">
                    ...
                    <telerik:RadComboBox ID="cmbTipoDescripcion" runat="server" Width="100%" ClientIDMode="Static"
                        ...
                        <Items>
                            ...
                            <telerik:RadComboBoxItem Text="Ingresos" Value="1" />
                            <telerik:RadComboBoxItem Text="Egresos" Value="2" />
                            <telerik:RadComboBoxItem Text="Cuentas por cobrar" Value="3" />
                            <telerik:RadComboBoxItem Text="Cuentas por pagar" Value="4" />
                        </Items>
                    </telerik:RadComboBox>
                </div>
        ...
        <div class="shadowed-div-body" style="width: 100%; margin-top: 20px;">
            <div>
               ...
               <a style="margin-left: 25px;">Filtrar por módulo</a>
                 <telerik:RadComboBox ID="cmbTipoDescripcion_Consulta" runat="server" Width="100%" ClientIDMode="Static" Style="max-width: 230px;"
                     MaxHeight="200px" AllowCustomText="True" Sort="Ascending" TabIndex="6"
                     MarkFirstMatch="true" OnClientKeyPressing="ChangeToUpperCase" RenderMode="Lightweight" Skin="Bootstrap" OnSelectedIndexChanged="cmbTipoDescripcion_Consulta_SelectedIndexChanged"
            ...
            <div class="col-12 div-gridview">
                <telerik:RadGrid RenderMode="Lightweight" ID="gvDatos" runat="server" Culture="es-DO" Style="overflow-x: auto;" BorderColor="White" MasterTableView-Width="100%" Width="100%" HeaderStyle-Font-Bold="true" AlternatingItemStyle-BackColor="#F1F5FF"
                    ...
                    MasterTableView-PagerStyle-FirstPageToolTip="" MasterTableView-PagerStyle-PrevPageToolTip="" MasterTableView-PagerStyle-NextPageToolTip="" MasterTableView-PagerStyle-LastPageToolTip="" PageSize="50"
                    ...
                    <MasterTableView AutoGenerateColumns="False">
                        <Columns>
                            <telerik:GridTemplateColumn>
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("Id_Descripcion") %>' OnClick="btnEditar_Click" CssClass="btn btn-sm btn-primary fa-solid fa-pen boton_formulario_editar" Style="height: 30px; width: 30px; padding: 7px; border-radius: 15px; margin-bottom: 3px;"></asp:LinkButton>
                                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("Id_Descripcion") %>' OnClick="btnEliminar_Click" OnClientClick="return delalert(this);" CssClass="btn btn-sm btn-danger fa-solid fa-trash" Style="height: 30px; width: 30px; padding: 7px; border-radius: 15px;"></asp:LinkButton>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>

                            <telerik:GridBoundColumn DataField="Id_Descripcion" HeaderText="ID" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="Nombre" HeaderText="Nombre" HeaderStyle-Width="60%" ItemStyle-Width="60%">
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="Tipo_Descripcion" HeaderText="Módulo" HeaderStyle-Width="20%" ItemStyle-Width="20%">
                            </telerik:GridBoundColumn>
