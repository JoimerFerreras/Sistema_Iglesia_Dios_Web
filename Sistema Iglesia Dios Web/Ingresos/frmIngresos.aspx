                                ...
                                <MasterTableView AutoGenerateColumns="False">
                                    <Columns>
                                        <telerik:GridTemplateColumn>
                                            ...
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" CommandArgument='<%#Eval("Id_Archivo") %>' OnClick="btnDescargarArchivo" CssClass="btn btn-sm btn-primary fa-solid fa-cloud-arrow-down boton_formulario_editar" Style="height: 30px; width: 30px; padding: 7px; padding-left:6px; border-radius: 15px; margin-bottom: 3px;"></asp:LinkButton>
                                                <asp:LinkButton runat="server" CommandArgument='<%#Eval("Id_Archivo") %>' OnClick="btnEliminarArchivo" OnClientClick="return delalert(this);" CssClass="btn btn-sm btn-danger fa-solid fa-trash" Style="height: 30px; width: 30px; padding: 7px; border-radius: 15px;"></asp:LinkButton>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        ...
                                        <telerik:GridBoundColumn DataField="Descripcion" HeaderText="Descripcion" HeaderStyle-Width="30%" ItemStyle-Width="30%">
                                        </telerik:GridBoundColumn>

                                        <telerik:GridBoundColumn DataField="NombreArchivoCarpeta" HeaderText="Archivo" HeaderStyle-Width="30%" ItemStyle-Width="30%">
                                        </telerik:GridBoundColumn>
