        ...
        <div class="shadowed-div-body" style="width: 100%;">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    Nombre del rol
                    <asp:TextBox runat="server" ID="txtNombreRol" CssClass="form-control form-control" Width="100%" TabIndex="2"></asp:TextBox>
                </div>
            ...
            <div class="row">
                <div class="col-12 col-md-3">
                    Fecha de registro
                  <asp:TextBox runat="server" ID="txtFechaRegistro" CssClass="form-control form-control" Width="100%" ReadOnly="true" TabIndex="1" Style="max-width: 300px;"></asp:TextBox>
                </div>

                <div class="col-12 col-md-3">
                    Fecha de registro
                 <asp:TextBox runat="server" ID="txtFechaUltimaModificacion" CssClass="form-control form-control" Width="100%" ReadOnly="true" TabIndex="1" Style="max-width: 300px;"></asp:TextBox>
                </div>
            </div>
        </div>
                ...
                <telerik:RadGrid RenderMode="Lightweight" ID="gvDatos" runat="server" Culture="es-DO" Style="overflow-x: auto;" BorderColor="White" MasterTableView-Width="100%" Width="100%" HeaderStyle-Font-Bold="true" AlternatingItemStyle-BackColor="#F1F5FF"
                    ...
                    <MasterTableView AutoGenerateColumns="False">
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="Fecha_Ultima_Modificacion" HeaderText="Fecha de última modificación" DataFormatString="{0:dd/MM/yyyy}" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                            </telerik:GridBoundColumn>
