<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmMiscelaneos.aspx.cs" Inherits="Sistema_Iglesia_Dios_Web.Otros_Parametros.frmMiscelaneos" %>
        ...
        <div class="shadowed-div-body" style="width: 100%;">
            <div class="row" style="margin-top: 20px;">
                <div class="col-12 col-md-1">
                    ID
                    <asp:TextBox runat="server" ID="txtId_Miscelaneo" CssClass="form-control form-control" Width="100%" ReadOnly="true" TabIndex="1" Style="max-width: 150px;"></asp:TextBox>
                </div>
                    ...
                    <MasterTableView AutoGenerateColumns="False">
                        <Columns>
                            <telerik:GridTemplateColumn>
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("Id_Miscelaneo") %>' OnClick="btnEditar_Click" CssClass="btn btn-sm btn-primary fa-solid fa-pen boton_formulario_editar" Style="height: 30px; width: 30px; padding: 7px; border-radius: 15px; margin-bottom: 3px;"></asp:LinkButton>
                                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("Id_Miscelaneo") %>' OnClick="btnEliminar_Click" OnClientClick="return delalert(this);" CssClass="btn btn-sm btn-danger fa-solid fa-trash" Style="height: 30px; width: 30px; padding: 7px; border-radius: 15px;"></asp:LinkButton>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridBoundColumn DataField="Id_Miscelaneo" HeaderText="ID" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="Descripcion_Miscelaneo" HeaderText="Descripción" HeaderStyle-Width="90%" ItemStyle-Width="80%">
                            </telerik:GridBoundColumn>
